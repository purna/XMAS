...
public class MoveObjectLeftWithDistance : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float distanceMoved = startPositionX - transform.position.x;

        // Check if the object has moved past the desired distance
        if (distanceMoved < distanceToMove)
        {
            // Move the object to the left as long as the distance hasn't been reached
